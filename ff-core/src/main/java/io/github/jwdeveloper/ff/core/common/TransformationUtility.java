...
public class TransformationUtility {
    ...
    public static class TransformationBuilder {
        ...
        public TransformationBuilder setLeftRotation(float degress, float x, float y, float z) {
            this.leftRotation.set(new AxisAngle4f((float) Math.toRadians(degress), x, y, z));
            return this;
        }

        public TransformationBuilder setRightRotation(float degress, float x, float y, float z) {
            this.rightRotation.set(new AxisAngle4f((float) Math.toRadians(degress), x, y, z));
            return this;
        }
        ...
        public TransformationBuilder setRightRotation(Vector vector)
        {
            ...
            var quaternion2 = new Quaternionf().rotationYXZ(
                    (float) Math.toRadians(vector.getY()),
                    (float) Math.toRadians(vector.getX()),
                    (float) Math.toRadians(vector.getZ())
            );
           // this.leftRotation = this.rightRotation;
            this.rightRotation = quaternion2;
            return this;
        }
