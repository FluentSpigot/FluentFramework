...
public class SimpleCommandRegistryImpl extends EventBase implements SimpleCommandRegistry {
    private final Map<String, SimpleCommand> commands;
    private final SimpleCommandMap commandMap;

    public SimpleCommandRegistryImpl(Plugin plugin) {
        super(plugin);
    ...
    private SimpleCommandMap getCommandMap() {
        try {
            return (SimpleCommandMap) ObjectUtils.getPrivateField(Bukkit.getServer(), "commandMap");
        } catch (Exception e) {
