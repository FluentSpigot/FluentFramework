...
public class ButtonUIBuilder<SELF extends ButtonUIBuilder<SELF, B>, B extends ButtonUIOld>
{
    ...
    public SELF setOnClick(ButtonUIEventOLD onClick)
    {
      //  button.setOnLeftClick(onClick);
        return self();
    }
    public SELF setOnShiftClick(ButtonUIEventOLD onClick)
    {
      //  button.setOnShiftClick(onClick);
        return self();
    }
    public SELF setOnRightClick(ButtonUIEventOLD onClick)
    {
