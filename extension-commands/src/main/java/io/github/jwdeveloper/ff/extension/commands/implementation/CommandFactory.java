...
public class CommandFactory {
    public List<CommandInvoker> create(Class<?> clazz, SimpleCommandBuilder builder) {
        var invokers = handleChildren(clazz, builder);
        handleCommandAnnotation(null, clazz, builder);
        var invoker = new CommandInvoker(clazz, builder);
    ...
    private List<CommandInvoker> handleChildren(Class<?> clazz, SimpleCommandBuilder builder) {
        var list = new ArrayList<CommandInvoker>();
        var children = clazz.getDeclaredAnnotationsByType(CommandChild.class);
        for (var child : children)
        {
            var childBuilder = SimpleCommandApi.create(child.childClass().getSimpleName());
    ...
    private void handleMethods(Class<?> clazz, SimpleCommandBuilder builder, CommandInvoker invoker) {
        for (var method : clazz.getDeclaredMethods()) {
            handleMethod(clazz, method, builder, invoker);
        }
    }

    private void handleMethod(Class<?> clazz, Method method, SimpleCommandBuilder builder, CommandInvoker invoker) {
    ...
    private void handleInvoke(Method method, SimpleCommandBuilder builder, CommandInvoker invoker) {
    ...
    private void handleArgumentAnnotation(Class<?> clazz, AnnotatedElement element, SimpleCommandBuilder builder, CommandInvoker invoker) {
    ...
    private void addTabComplete(Class<?> clazz, ArgumentBuilder builder, String methodName, CommandInvoker invoker) {
    ...
    private void addValidationMessage(Class<?> clazz, ArgumentBuilder builder, String methodName, CommandInvoker invoker) {
