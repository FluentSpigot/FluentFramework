...
public class PacketManager
{
   ...
   private static final Reflection.FieldAccessor<String> getPlayerName = Reflection.getField(PACKET_LOGIN_IN_START, String.class, 0);
     ...
     */
    public PacketManager(final Plugin plugin) {
        this.plugin = plugin;
    ...
    public void injectPlayer(Player player) {
        FluentLogger.LOGGER.info("INJECTION PLAYER!");
    ...
    private final class PacketInterceptor extends ChannelDuplexHandler {
        ...
        private void handleLoginStart(Channel channel, Object packet) {
            ...
            {
                var profileName = getPlayerName.get(packet);
                channelLookup.put(profileName, channel);
            }
        }
    }
}
