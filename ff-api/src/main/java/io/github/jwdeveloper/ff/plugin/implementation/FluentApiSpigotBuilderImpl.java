...
public class FluentApiSpigotBuilderImpl implements FluentApiSpigotBuilder {
    ...
    public FluentApiSpigot build() throws Exception {
        ...
        extensionsManager.register(builder ->
        {
            defaultCommandBuilder.register();
        }, ExtentionPriority.HIGH);
        ...
        {
            e.container()
                    .findAllByInterface(Closeable.class)
                    .forEach(closeable ->
                    {
                        try {
                            closeable.close();
        ...
        containerBuilder.registerSingleton(Commands.class, commands);
        ...
        containerBuilder.scan(eventManager ->
        {
            eventManager.setRootPackage(plugin.getClass());
        });
        ...
        final var cache = injection.findInjection(PluginCache.class);
